...
Deploy + spawn:
    ...
    uv run python -c "import modal; f = modal.Function.from_name('fusion-mveb-fe1', 'run_tasks'); print(f.spawn('probe').object_id)"
Pull results:
...
CACHE_DIR = "/vol/mveb_fe1/results_cache"
